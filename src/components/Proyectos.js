...
const Proyectos = () => {
  return (
    <div id="proyectos" className='bg-[#302129] py-6 lg:py-12 lg:px-[150px] px-10'>
          ...
          <div className='items-center justify-center'>
              ...
              <div>
                {projects.map((project, index) => {
                  return (
                    <div className='flex justify-center p-6 ' key={index}>
                      <div>
                          <img src={project.image} alt='' className='h-[150px] w-[150px] justify-start px-4 mr-4 left-8'/>
                      </div>
                      <div>
